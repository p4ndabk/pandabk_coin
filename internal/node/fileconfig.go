...
// vence. configFlag é o valor do flag -config: vazio usa o panda.conf do
...
// panda.conf serve para CLI, demo e app de desktop. Devolve o conjunto de
...
func ApplyConfigFile(fs *flag.FlagSet, configFlag string) (map[string]bool, error) {
	...
	if err != nil {
		if !explicit && os.IsNotExist(err) {
			return fromCLI, nil // sem panda.conf por perto: nada a aplicar
		}
